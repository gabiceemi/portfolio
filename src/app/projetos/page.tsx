        ...
        <div className="mb-4 flex flex-col md:mr-4">
          <a href="">
            ...
            <p className="mt-2 w-[280px] px-2">
              O Ecoleta é um marketplace que ajuda pessoas a encontrarem pontos
              de coleta de resíduos de forma eficiente.
            </p>
          </a>
        </div>
        <div className="mb-4 flex flex-col md:mr-4">
          ...
          <p className="mt-2 w-[280px] px-2">
            ...
            escolher em uma lista de barbeiros e barbeiros para acompanhar seus
            compromissos.
          </p>
        </div>
        <div className="mb-4 flex flex-col md:mr-4">
